...
session_start();
$isLoggedIn = isset($_SESSION['user']) || isset($_SESSION['username']);
...
<body class="progress-page">
  <div id="loginOverlay" <?php if(!$isLoggedIn) echo 'style="display:flex"'; ?>>
    <div class="popup">
      <p>É necessário efetuar login para utilizar esta página.</p>
