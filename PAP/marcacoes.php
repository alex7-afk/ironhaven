...
<body class="pagina-marcacoes">
  ...
  <div class="main-content">
    ...
    <div class="calendar-type-controls" style="display: flex; gap: 10px; justify-content: center; margin-bottom: 20px;">
      ...
      <button class="app-type-btn" id="btn-nutricao">Nutrição</button>
    ...
    <div id="tutorialSection" style="display:none; margin-top:10px; text-align:left;">
      <h3>Tutorial</h3>
      <p>Selecione o tipo de marcação que pretende no menu acima.</p>
  ...
  function highlightButton(type) {
    ...
    if (type === 'training') document.getElementById('btn-treinos').classList.add('active');
     if (type === 'consultation') document.getElementById('btn-nutricao').classList.add('active');
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('btn-nutricao').onclick = function() {
